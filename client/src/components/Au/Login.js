    ...
    componentWillReceiveProps(nexProps){
      ...
      if(nexProps.auth.isAuthenticated){
        if(nexProps.auth.user.emailVerified){
          ...
          if( nexProps.auth.user.tags.length==0) window.location.href="https://hakunamatatasite.herokuapp.com/startAs"
          else{
            if( nexProps.auth.user.tags.length>0) window.location.href="https://hakunamatatasite.herokuapp.com/HomePage"
      }
      }
       else  window.location.href="https://hakunamatatasite.herokuapp.com/verificationpage"
      }
      if(nexProps.errors){
