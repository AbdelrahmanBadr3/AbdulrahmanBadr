...
class Card extends Component {
    ...
    async handleClick() {
        ...
        await axios.put(`https://hakunamatatasite.herokuapp.com/members/applyForMasterClass/${handle}`, data);
  ...
  this.setState({eduId:id})
            axios
          .get(`https://hakunamatatasite.herokuapp.com/masterClasses/${masterClassId}`)
          .then(res => {
