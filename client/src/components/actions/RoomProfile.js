...
class Card extends Component {
    ...
    this.setState({coWorkingSpaceId:id})
              axios
            .get(`https://hakunamatatasite.herokuapp.com/api/coworkingSpaces/room/${id}/${roomId}`)
            .then(res => {
...
//           }
//         };
//         await axios.put(`https://hakunamatatasite.herokuapp.com/api/coWorkingSpaces/room/reserve/${id}/${roomId}`, data).catch(e => {
//             alert(e)
//           }).then(alert('Done: '));
