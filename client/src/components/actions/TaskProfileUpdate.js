...
this.onChange=this.onChange.bind();
  ...
  componentDidMount() {
    ...
    console.log(id);
    axios.get(`https://hakunamatatasite.herokuapp.com/api/tasks/${id}`).then(res => {
 ...
 const data={
    ...
    axios.put('https://hakunamatatasite.herokuapp.com/api/tasks/' + this.props.match.params.id, data)
