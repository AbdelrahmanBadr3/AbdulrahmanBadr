...
const  data= {
  ...
  axios.put(`https://hakunamatatasite.herokuapp.com/api/trainingPrograms/${params.id}`,data).then(response => { 
...
handleDelete= event =>{
  ...
  axios.delete(`https://hakunamatatasite.herokuapp.com/api/trainingProgram/$${params.id}`).then(response => { 
  console.log(response)
