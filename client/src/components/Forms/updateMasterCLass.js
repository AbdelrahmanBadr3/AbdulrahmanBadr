...
export class updateMasterClass extends Component {
    ...
    descriptionChange = (e) => {
        ...
        onSubmit = (e) => {
          ...
          const {id,masterClassId}=this.props.match.params
              ...
              axios.put(`https://hakunamatatasite.herokuapp.com/api/masterClasses/${masterClassId}`,{
    ...
    async handleClick() {
      ...
      await axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForMasterClass/${handle}`, data);
  ...
  this.setState({eduId:id})
            axios
          .get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/masterClass/${id}/${masterClassId}`)
          .then(res => {
