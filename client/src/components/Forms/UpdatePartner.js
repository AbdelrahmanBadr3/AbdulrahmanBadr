   ...
   state = {
    ...
    componentDidMount() {
      ...
      const {id}=this.props.match.params
        axios.get(`https://hakunamatatasite.herokuapp.com/api/partners/${id}`).then(res => {
    ...
    if(fieldOfWork&&fieldOfWork!=""){
      data.fieldOfWork=fieldOfWork.split(',')
        ...
        axios.put(`https://hakunamatatasite.herokuapp.com/api/partners/${id}`,data)
    
    
    
        // window.location = "https://hakunamatatasite.herokuapp.com/UpdatePartner/"+id;
    }
