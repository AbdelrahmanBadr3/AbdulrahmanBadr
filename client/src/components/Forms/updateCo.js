...
export class updateCo extends Component {
    ...
    componentDidMount() {
      const {id}=this.props.match.params
        axios
          .get(`https://hakunamatatasite.herokuapp.com/api/coworkingSpaces/${id}`)
          .then(res => {
            ...
            axios
          .get(`https://hakunamatatasite.herokuapp.com/api/coworkingSpaces/room/${id}`)
          .then(res => {
  ...
  for(let i=0 ; i<coworkingSpacePhoneNumber.length ; i++ ){
    ...
    axios.delete('https://hakunamatatasite.herokuapp.com/api/coworkingSpaces/'+id)
    window.alert(id)
    window.location('https://hakunamatatasite.herokuapp.com/api/coworkingSpaces/'+id)
      }
      updateFun (){
        ...
        var url = window.location.pathname;
         var id = url.substring(url.lastIndexOf('/') + 1);
         axios.put('https://hakunamatatasite.herokuapp.com/api/coWorkingSpaces/' + id , data)
