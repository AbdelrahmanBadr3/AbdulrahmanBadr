...
componentDidMount(){
  if(this.props.auth.isAuthenticated){
    ...
    if(this.props.auth.user.emailVerified) {
      ...
      if(this.props.auth.user.tags ==undefined ||this.props.auth.user.tags ==null ||this.props.auth.user.tags.length ==0)  window.location.href="https://hakunamatatasite.herokuapp.com/startAs"
      window.location.href="https://hakunamatatasite.herokuapp.com/Homepage"
    }
  }else{
    window.location.href="https://hakunamatatasite.herokuapp.com/"
  }
}
