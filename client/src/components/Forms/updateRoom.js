...
export class GetSpec extends Component {
    ...
    componentDidMount() {
        const {id,roomId}=this.props.match.params
            ...
            axios
          .get(`https://hakunamatatasite.herokuapp.com/api/rooms/${roomId}`)
          .then(res => {
    ...
    updateFun(){
        ...
        axios.put('https://hakunamatatasite.herokuapp.com/api/rooms/' + id , data)
      window.location = `https://hakunamatatasite.herokuapp.com/coWorkingSpaces/5cab83e86b8f820fc0bcf768/showRooms/${id}`
    }
