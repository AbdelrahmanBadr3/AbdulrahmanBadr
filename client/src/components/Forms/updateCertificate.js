...
export class updateCertificate extends Component {
    ...
    onSubmit = (e) => {
        ...
        const {id,certificateId}=this.props.match.params
            ...
            axios.put(`https://hakunamatatasite.herokuapp.com/api/certificates/${certificateId}`,{
    ...
    componentDidMount() {
        const {id,certificateId}=this.props.match.params
            ...
            axios
          .get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/certificate/${id}/${certificateId}`)
          .then(res => {
