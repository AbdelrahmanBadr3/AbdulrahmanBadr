...
export class GetSpecificEdu extends Component{
    ...
    onSubmit = (e) => {
        ...
        const {id}=this.props.match.params
            ...
            axios.put(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/${id}`,{
    ...
    componentDidMount(){
      var id;
        ...
        axios.get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/${id}`).then(res=>{
            this.setState({
      ...
      axios
      .get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/course/${id}`)
      .then(res => {
        ...
        axios
        .get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/masterClass/${id}`)
        .then(res => {
          ...
          axios
          .get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/educator/${id}`)
          .then(res => {
            ...
            axios
          .get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/certificate/${id}`)
          .then(res => {
            ...
            axios
          .get(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/trainingProgram/${id}`)
          .then(res => {
