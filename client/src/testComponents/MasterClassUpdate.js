...
class MasterClassUpdate extends Component {
    ...
    handleDelete(){
        ...
        axios.delete(`https://hakunamatatasite.herokuapp.com/api//${id}`).then(res =>{
        swal({
            title: "Done",
            text: res.data.msg,
            icon: "success",
    ...
    onSubmit(event) {
        ...
        axios.put(`https://hakunamatatasite.herokuapp.com/api/masterClasses/${id}`, data).then(res =>{
        swal({
            title: "Done",
            text: res.data.msg,
            icon: "success",
    ...
    componentDidMount() {
        ...
        // axios
        //     .get(`https://hakunamatatasite.herokuapp.com/api/skills`)
        //     .then(res => {
