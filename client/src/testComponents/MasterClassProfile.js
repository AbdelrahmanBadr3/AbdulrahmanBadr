...
class MasterclassProfile extends Component {
    ...
    componentDidMount() {
        ...
        // //console.log(id);
        axios.get(`https://hakunamatatasite.herokuapp.com/api/masterClasses/${id}`).then(res => {
            ...
            window.location.href =`https://hakunamatatasite.herokuapp.com/NotFound`
        }
    ...
    handleClickMember =()=> {
        ...
        const data = {
            ...
            axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForMasterClass/${memberId}`, data).then(res =>{
                swal({
                    title: "Done",
                    text: res.data.msg,
                    icon: "success",
                  })
                  window.location.href =`https://hakunamatatasite.herokuapp.com/masterClasses/${id}`
                }
                ).catch(e => {
    ...
    assignMember = (memberId,state) =>{
        ...
        axios.put(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/acceptMemberInMasterClass/${this.props.auth.user._id}`, data).then(res =>{
            swal({
                title: "Done",
                text: res.data.msg,
                icon: "success",
