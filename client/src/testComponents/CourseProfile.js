...
class CourseProfile extends Component {
    ...
    componentDidMount() {
        ...
        // ////////////////console.log(id);
        axios.get(`https://hakunamatatasite.herokuapp.com/api/courses/${id}`).then(res => {
    ...
    handleClickMember =()=> {
        ...
        const data = {
            ...
            axios.put(`https://hakunamatatasite.herokuapp.com/api/members/applyForCourse/${memberId}`, data).then(res =>{
                swal({
                    title: "Done",
                    text: res.data.msg,
                    icon: "success",
                  })
                  window.location.href =`https://hakunamatatasite.herokuapp.com/courses/${id}`
                }
                ).catch(e => {
    ...
    assignMember = (memberId,state) =>{
        ...
        axios.put(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/acceptMemberInCourse/${this.props.auth.user._id}`, data).then(res =>{
            swal({
                title: "Done",
                text: res.data.msg,
                icon: "success",
