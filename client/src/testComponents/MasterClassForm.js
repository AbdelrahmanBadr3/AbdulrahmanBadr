...
class MasterclassForm extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .get(`https://hakunamatatasite.herokuapp.com/api/members`)
            .then(res => {
                let arr = []
    ...
    handleSubmit(event) {
        ...
        axios.post(`https://hakunamatatasite.herokuapp.com/api/educationalOrganizations/masterClass/${this.props.auth.user._id}`, data).then(res =>
        swal({
            title: "Done",
            text: res.data.msg,
            icon: "success",
